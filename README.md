...
```
    ...
    print("-------------------")
```
when choosing *[c] Encrypt File*. Remember to populate first the *upload.txt* file (the words you want to encrypt or decrypt) located in the folder for encryption
